               ...
               <div className="contentBx active" id='content1'>
                  <div className="relative flex justify-center items-center flex-col">
                     ...
                     <div className="flex items-center justify-center flex-col mt-4">
                        <h2 className='relative text-[1.25em] font-semibold text-teal-500 leading-[1em] uppercase text-center'>Thewan Damnidu<br /><span className='text-[0.65em] font-medium tracking-widest'>IT22602978</span></h2>
